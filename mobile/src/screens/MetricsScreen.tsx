                  ...
                  <View
                    style={[
                      styles.bar,
                      {
                        ...
                        backgroundColor: isToday ? color.accent400 : color.accent600,
                      },
...
const styles = StyleSheet.create({
  ...
  headlineValue: { fontFamily: font.heading, fontSize: 28, color: color.text },
  headlineSub: { fontSize: 13, color: 'rgba(233,233,237,0.55)' },
  last7: { fontSize: 12, color: 'rgba(233,233,237,0.55)' },
  ...
  barToday: { borderWidth: 1, borderColor: color.accent },
  barLabel: { fontSize: 11, color: 'rgba(233,233,237,0.55)' },
  barLabelToday: { color: color.accent200 },
  tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  tableHeader: {
    flexDirection: 'row',
    padding: 12,
    borderBottomWidth: StyleSheet.hairlineWidth,
    borderBottomColor: 'rgba(233,233,237,0.12)',
  },
  th: { fontSize: 10.5, letterSpacing: 0.8, color: 'rgba(233,233,237,0.6)' },
  thRight: { flex: 0.7, textAlign: 'right' },
  tableRow: {
    flexDirection: 'row',
    padding: 12,
    borderBottomWidth: StyleSheet.hairlineWidth,
    borderBottomColor: 'rgba(233,233,237,0.06)',
  },
  td: { fontSize: 13, color: color.text },
  tdMuted: { color: 'rgba(233,233,237,0.55)' },
